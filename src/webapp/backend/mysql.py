...
=======
	_execute_sql(conn, "INSERT INTO votes (person_ID, bill_ID, voted_for, date) VALUES (***REMOVED***0***REMOVED***, ***REMOVED***1***REMOVED***, ***REMOVED***2***REMOVED***, ***REMOVED***3***REMOVED***);".format(personID, billID, "for" if votedFor else "against", date))
>>>>>>> e0b18fd183b9039bca5441707f3202237b230036
